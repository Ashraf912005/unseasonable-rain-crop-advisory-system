...
# -----------------------------------------------------
# -----------------------------------------------------
# 🌾 Multilingual Mappings for Maharashtra Data
# -----------------------------------------------------

# 36 districts of Maharashtra
# -----------------------------------------------------
# 🌾 Multilingual Mapping (Updated: 36 districts, 5 soil types, 3 seasons)
# -----------------------------------------------------
...
def get_weather_alert(temp, humidity, rainfall):
    """
    Return a list of localized alert strings using the language pack T.
    Uses messages stored under T['alerts'] (so ensure T is the selected language dict).
    """
    alerts = []

    # Unseasonal / heavy rainfall: highest priority
    if rainfall > 1200:
    ...
    # If no alerts were triggered, return the favorable message
    if not alerts:
