...
LANGUAGES = {
    "English": {
        ...
        "alerts": {
            "unseasonal": "⚠️ Unseasonal Rain — delay in irrigation and fertilizer use, ensure drainage, and protect harvest.",
    ...
    "हिंदी": {
        ...
        "soil": "🌱 मिट्टी सिफारिश",
        "alerts": {
            "unseasonal": "⚠️ असमय वर्षा — उर्वरक और सिंचाई डालना रोकें, निकासी सुनिश्चित करें और फसल को नमी से बचाएं।",
