...
with col_info:
    st.markdown(f"""
        <div style="
            ...
            ">
            <h4 style="margin-bottom:10px;">{rainfall_reference[lang_choice]['title']}</h4>
            <div style="font-size:14px; margin-bottom:8px;">
                <b>🌾 Kharif:</b><br>
                • {rainfall_reference[lang_choice]['Kharif'][0][0]} – {rainfall_reference[lang_choice]['Kharif'][0][1]}<br>
                • {rainfall_reference[lang_choice]['Kharif'][1][0]} – {rainfall_reference[lang_choice]['Kharif'][1][1]}<br>
                • {rainfall_reference[lang_choice]['Kharif'][2][0]} – {rainfall_reference[lang_choice]['Kharif'][2][1]}<br><br>
                <b>🌾 Rabi:</b><br>
                • {rainfall_reference[lang_choice]['Rabi'][0][0]} – {rainfall_reference[lang_choice]['Rabi'][0][1]}<br>
                • {rainfall_reference[lang_choice]['Rabi'][1][0]} – {rainfall_reference[lang_choice]['Rabi'][1][1]}<br>
                • {rainfall_reference[lang_choice]['Rabi'][2][0]} – {rainfall_reference[lang_choice]['Rabi'][2][1]}<br><br>
                <b>🌾 Zaid:</b><br>
                • {rainfall_reference[lang_choice]['Zaid'][0][0]} – {rainfall_reference[lang_choice]['Zaid'][0][1]}<br>
                • {rainfall_reference[lang_choice]['Zaid'][1][0]} – {rainfall_reference[lang_choice]['Zaid'][1][1]}<br>
                • {rainfall_reference[lang_choice]['Zaid'][2][0]} – {rainfall_reference[lang_choice]['Zaid'][2][1]}
            </div>
            <p style="font-size:12px;color:#475569;margin-top:10px;">ℹ️ {rainfall_reference[lang_choice]['note']}</p>
        </div>
